...
import '../../controller/get_terms_controller.dart';
...
class _PrivacyAndPolicyState extends State<PrivacyAndPolicy> {
  ...
  GetTermsModel? getTermsModel;
  Future<void> getData() async {
    setState(() => requestState = RequestState.loading);
    final res = await GetTermsController.getTerms();
    if (res) {
      getTermsModel = GetTermsController.getTermsModel;
      ...
      return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Flexible(
              child: Text(
                getTermsModel!.data!.terms!.first.name!,
